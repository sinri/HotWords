...
class Stemmer {
    ...
    private boolean vowelinstem() {
        int inner_i;
        for (inner_i = 0; inner_i <= j; inner_i++) {
            if (!cons(inner_i)) {
                return true;
            }
        }
    ...
    private boolean ends(String s) {
        ...
        for (int inner_i = 0; inner_i < l; inner_i++) {
            if (b[o + inner_i] != s.charAt(inner_i)) {
                return false;
            }
        }
        j = k - l;
    ...
    /**
     * @deprecated 
     * A test function to experience usage.
     * @param text 
     */
    ...
    public static String wordNormalize(String anyword){
        Stemmer s = new Stemmer();
